...
def test_parse_pipfile():
    ...
    with open(file_path, "r") as f:
        assert parse_helper.parse_pipfile(f) == expected_output
...
def test_parse_pyproject_toml():
    ...
    expected_output = ["numpy", "pandas", "matplotlib"]
    with open(file_path, "r") as f:
        assert parse_helper.parse_pyproject_toml(f) == expected_output


def test_parse_requirements_file():
    file_path = "test_data/requirements.txt"
    expected_output = ["numpy", "pandas", "matplotlib"]
    assert parse_helper.parse_requirements_file(file_path) == expected_output
...
def test_parse_cargo_toml():
    ...
    with open(file_path, "r") as f:
        assert parse_helper.parse_cargo_toml(f) == expected_output
...
def test_parse_cargo_lock():
    ...
    expected_output = ["serde", "tokio", "log"]
    with open(file_path, "r") as f:
        assert parse_helper.parse_cargo_lock(f) == expected_output
...
def test_parse_package_json():
    ...
    with open(file_path, "r") as f:
        assert parse_helper.parse_package_json(f) == expected_output
...
def test_parse_yarn_lock():
    ...
    expected_output = ["express", "lodash", "debug"]
    with open(file_path, "r") as f:
        assert parse_helper.parse_yarn_lock(f) == expected_output
