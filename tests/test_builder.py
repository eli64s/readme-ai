...
from src.builder import (build, create_directory_tree, create_setup_guide,
                  create_tables, format_badges, get_badges, parse_pandas_cols)
...
def test_get_badges():
    badge_metadata = {
        "icons": [
            {"name": "dependency1", "src": "https://img.shields.io/badge/dependency1-src1"},
            {"name": "dependency2", "src": "https://img.shields.io/badge/dependency2-src2"}
        ]
    }
...
def test_format_badges():
    ...
    assert '<img src="https://img.shields.io/badge/dependency1-src1" alt="dependency1" />' in formatted_badges
    assert '<img src="https://img.shields.io/badge/dependency2-src2" alt="dependency2" />' in formatted_badges
    assert '<img src="https://img.shields.io/badge/dependency3-src3" alt="dependency3" />' in formatted_badges
