...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 200">
    ...
    <text x="400" y="100" font-family="Arial, sans-serif" font-size="48" font-weight="bold" text-anchor="middle" dominant-baseline="middle" fill="#FFFFFF" filter="url(#shadow)">
    {title.upper()}
    </text>
</svg>
"""
    ...
    return f"""<img src="data:image/svg+xml;base64,{svg_base64}" alt="{title.lower()}" width="800">"""
...
def generate_ascii_box_banner(title: str, tagline: str = "") -> str:
