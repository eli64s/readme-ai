...
|                                                                                                                                                                                      |                                                                                                |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
| <br><br/><b>📍 Getting Started </b><br><br>Generates instructions for using your project, including `dependencies`, `installation`,<br> and `usage` guides.<br> <br> | ![setup](docs/imgs/setup.png) |
