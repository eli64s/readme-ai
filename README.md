...
|                                                                                                                                                                                                                                                                                        |                             |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| <br><br/><b>📍 Codebase Documentation</b><br><br>Codebase documentation is <br>generated by the OpenAI API<br> `text-davinci-003` model engine. <br><br>Each file in your repo<br> is converted to<br> natural language,<br> grouped by directory,<br> and visualized in tables in your README file. | ![docs](./docs/imgs/docs.png) |
