...
|                                                                                                                                                         |                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| Introduction and Badges</b><br><br>An introduction sentence is generated by<br> `text-davinci-003` engine.<br><br>Project dependencies are visualized using beautiful SVG icon badges! | ![header](./docs/imgs/header.png) |
