...
|                                                                                                                                                                                                                    |                                   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|
| <b>📍 Introduction, Badges, and Table </b><br><br>An introduction of the project is populated using `text-davinci-003` language model.<br><br>Project dependencies are visualized using beautiful SVG icon badges!L<br><br>Also a table of contents for easy navigation!| ![header](./docs/imgs/header.png) |

<h1 align="center">⒊<br>👇<br><br>🧚 Overview & Features</h1>
<p align="center"><p>The next two sections of the README are generated by using detailed prompts sent to OpenAI's API. The prompts contain codebase metadata and are focused on use-case and benefits of your project. Still working to improve the accuracy of the generated text!</p>
</p>
