...
<h1 align="center">1.<br>👇<br><br>🔖 Repository Documentation</h1>
<table>
  <tr>
    <td>
...
<table>
  <tr>
    <td>
      ...
      <ul>
        <li>The 1-sentence catchphrase is generated by OpenAI's <code>text-davinci-003</code> engine</li>
...
<table>
  <tr>
    <td>
      ...
      <ul>
        <li>Generated using detailed prompts that are embedded with your repository</li><li>Working on fine-tuning the prompts to improve the accuracy and relevance to your project</li>
      </ul>
    </td>
  </tr>
  <tr>
