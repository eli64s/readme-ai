...
|                                                                                                                                                                                              |                                   |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------|
| <b>📍 Introduction, Badges, and Table </b><br><br>An introduction of the project is populated using `text-davinci-003` language model.<br><br>Project dependencies are visualized using beautiful SVG icon badges! | ![header](./docs/imgs/header.png) |

<h1 align="center">⒊<br>👇<br><br>🧚 Overview & Features</h1>
<p align="center">The overview and feature sections are generated by OpenAI's language models.
</p>

|                                                                                                                                                                                             |                             |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|
| <br><br/><b>📍 Overview & Features</b><br><br>OpenAI generated text populates<br> the overviewnd feature sections.<br><br> Detailed prompts are given to<br>OpenAI's API to generate and<br> introduction and features text.<br><br>The prompts focus on the project's use-case and benefit of the app or tool.<br><br>Still fine-tuning the prompts to generate more accurate text.  | ![toc](./docs/imgs/features.png) |
