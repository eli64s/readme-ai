...
<p align="center"><p>The next two sections in your README are generated by OpenAI language models, using detailed prompts embedded with your codebase metadata. Still working to improve the accuracy of the generated text!</p>
</p>

|                                       |
|---------------------------------------|
| ![features](./docs/imgs/overview.png) |
