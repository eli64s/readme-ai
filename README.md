...
|                                                                                                                                                                                                                                                    |                                 |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| <br><br/><b>📍 Project Badges and Intro</b><br><br>Extracts your dependencies and<br> displays them as badges<br> at the top of the README.<br><br>OpenAI API also creates a short slogan (the 1st sentence)<br> for the header section! | ![header](docs/imgs/header.png) |
