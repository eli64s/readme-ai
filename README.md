...
> 🚧 **Note:**
> 
> The README-AI project is still under development and has an opinionated configuration and setup. Thus, this tool provides a great starting point for any project that requires documentation. It is important to review all generated text produced by the OpenAI API! 
