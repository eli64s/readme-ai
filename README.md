...
> [!TIP]
>
> Offline mode is useful for quickly generating a boilerplate README without incurring API costs. The offline mode README file can be viewed [here](https://github.com/eli64s/readme-ai/blob/main/examples/markdown/readme-offline.md).
...
<table>
  ...
  <tr>
    <td align="center"><img src="https://github.com/eli64s/readme-ai/blob/main/examples/images/header-skils.png" alt="skills" width="400"/><br><code>--align left --badges flat-square --image black</code></td>
    <td align="center"><img src="https://github.com/eli64s/readme-ai/blob/main/examples/images/header-kotlin.png" alt="kotlin" width="400"/><br><code>--badges skills-light --image black</code></td>
  </tr>
  <tr>
    ...
    <td align="center"><img src="https://raw.githubusercontent.com/eli64s/readme-ai/main/examples/images/header-java.png" alt="gradient" width="400"/><br><code>--align left --badges flat-square --image black</code></td>
  </tr>
</table>
...
A remote repository URL or local path to your codebase is required to generate a README file. The repository hosts below are currently supported.
...
| **Image**    | Black | Blue | Green | Grey | Purple | White | Yellow |
|--------------|-------|------|-------|------|--------|-------|--------|
| **Preview**  | <img src="https://img.icons8.com/external-tal-revivo-regular-tal-revivo/96/external-readme-is-a-easy-to-build-a-developer-hub-that-adapts-to-the-user-logo-regular-tal-revivo.png" width="100" height="100" id="markdown"> | <img src="https://raw.githubusercontent.com/PKief/vscode-material-icon-theme/ec559a9f6bfd399b82bb44393651661b08aaf7ba/icons/folder-markdown-open.svg" width="100" height="100" id="markdown"> | <img width="72" height="72" src="https://img.icons8.com/external-tal-revivo-green-tal-revivo/72/external-markdown-a-lightweight-markup-language-with-plain-text-formatting-syntax-logo-green-tal-revivo.png" alt="external-markdown-a-lightweight-markup-language-with-plain-text-formatting-syntax-logo-green-tal-revivo"/> | <img width="96" height="96" src="https://img.icons8.com/external-tal-revivo-filled-tal-revivo/96/external-markdown-a-lightweight-markup-language-with-plain-text-formatting-syntax-logo-filled-tal-revivo.png" alt="external-markdown-a-lightweight-markup-language-with-plain-text-formatting-syntax-logo-filled-tal-revivo"/> | <img width="100" height="100" src="https://img.icons8.com/external-tal-revivo-duo-tal-revivo/100/external-markdown-a-lightweight-markup-language-with-plain-text-formatting-syntax-logo-duo-tal-revivo.png" alt="external-markdown-a-lightweight-markup-language-with-plain-text-formatting-syntax-logo-duo-tal-revivo"/> | <img width="80" height="80" src="https://img.icons8.com/officel/80/markdown.png" alt="markdown"/> | <img src="https://img.icons8.com/pulsar-color/96/markdown.png" width="100" height="100" id="markdown"> |
